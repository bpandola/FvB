(function () {
    ...
    var sfxMappings = [
        ...
        { constant: "SFX_CHARACTER_SELECT_THEME", sfx: "Street Fighter II Arcade Music - Character Select - CPS1" },
        ...
        { constant: "SFX_YOHAN_THEME", sfx: "Street Fighter II Arcade Music - Zangief Stage - CPS1" },
        { constant: "SFX_RYU_THEME", sfx: "ryu-theme" },
        { constant: "SFX_VERSUS_THEME", sfx: "9BH" },
{ constant: "SFX_YOU_WIN", sfx: "youwin" },
{ constant: "SFX_YOU_LOSE", sfx: "youlose" }
    ];

    var soundConsts = {};
    for (var i = 0, n = sfxMappings.length; i < n; i++) {
        soundConsts[sfxMappings[i].constant] = i; //sfxMappings[i].sfx;
    }

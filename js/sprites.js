...
// hitBoxes are relative to the entity x,y position, which is center x, bottom y
 ...
 { sprite: "SPR_YOULOSE_REGULAR", sheet: "ROUNDS.PNG", xOffset: 1, yOffset: 269, width: 198, height: 24, hitBox: null },
        ...
        // Ryu Idle
        { sprite: "SPR_RYU_IDLE_1", sheet: "RYU.PNG", xOffset: 64, yOffset: 0, width: 64, height: 98, hitBox: { x1: -5, x2: 5, y1: -64, y2: 0 } },
        { sprite: "SPR_RYU_IDLE_2", sheet: "RYU.PNG", xOffset: 128, yOffset: 0, width: 64, height: 98, hitBox: { x1: -5, x2: 5, y1: -64, y2: 0 } },
        { sprite: "SPR_RYU_IDLE_3", sheet: "RYU.PNG", xOffset: 192, yOffset: 0, width: 64, height: 98, hitBox: { x1: -5, x2: 5, y1: -64, y2: 0 } },
        { sprite: "SPR_RYU_IDLE_4", sheet: "RYU.PNG", xOffset: 256, yOffset: 0, width: 64, height: 98, hitBox: { x1: -5, x2: 5, y1: -64, y2: 0 } },
        // Ryu Walk
